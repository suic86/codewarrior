...
var _ = Describe("Sample Tests", func() {
	It("Sample Tests", func() {
		...
		test(2427, "Friday")
		test(2185, "Saturday")
		test(1084, "Tuesday", "Wednesday")
		test(1167, "Sunday")
		test(1216, "Friday", "Saturday")
		test(1492, "Friday", "Saturday")
		test(1770, "Monday")
		test(1785, "Saturday")
		test(212, "Wednesday", "Thursday")
		test(1, "Monday")
